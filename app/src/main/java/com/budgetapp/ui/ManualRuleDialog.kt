...
private fun CandidateRow(
    ...
    val directionColor = if (candidate.direction == com.budgetapp.domain.Direction.IN)
...
private fun describeCadence(cadence: com.budgetapp.domain.Cadence, anchorDay: Int): String = when (cadence) {
    com.budgetapp.domain.Cadence.WEEKLY -> "Weekly · ${dayName(anchorDay)}"
    com.budgetapp.domain.Cadence.FORTNIGHTLY -> "Every 2 weeks"
    com.budgetapp.domain.Cadence.MONTHLY -> "Monthly · day $anchorDay"
    com.budgetapp.domain.Cadence.MONTHLY_LAST_DAY -> "Monthly · last day"
    com.budgetapp.domain.Cadence.MONTHLY_LAST_BUSINESS_DAY -> "Monthly · last working day"
    com.budgetapp.domain.Cadence.QUARTERLY -> "Quarterly"
    com.budgetapp.domain.Cadence.ANNUAL -> "Yearly"
    else -> cadence.name
}
